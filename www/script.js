function ready() {
  //     cordova.plugins.backgroundMode.moveToBackground()
    ...
    //   alert(intent_string)
      ...
      const popupWidgetRegex = /"data":"openapp:\/\/popup\-widget\/pid\/\d+"}$/;
      const popupWidgetRegexHttps = /"data":"https:\/\/open\-app\.pulipuli\.info\/popup\-widget\/pid\/\d+"}$/;
  ...
  //           action: window.plugins.webintent.ACTION_MAIN,
            ...
            startApp.set({
      //         "component": [main, extracted],
              "component": [extracted, `${extracted}.WelcomeActivity`],
  //             action: 'android.intent.action.MAIN',
  ...
  //             "package": extracted
              ...
              startApp.set({
        //         "component": [main, extracted],
                "component": [extracted, `${extracted}.MainActivity`],
    //             action: 'android.intent.action.MAIN',
    //             category: 'android.intent.category.LAUNCHER',
    //             "package": extracted
              }).start(callbackExitApp, (e) => {
                ...
                var config = {
                  action: window.plugins.webintent.ACTION_VIEW,
                  url: `https://play.google.com/store/apps/details?id=${extracted}`
                };
  ...
  //           alert(JSON.stringify(e))
    ...
    //   const testRegex = /"data":"openapp:\/\/popup\-widget\/pid\/\d+"}$/;
    ...
    // );
        ...
        startApp.set({
          ...
          "component": ["com.atharok.barcodescanner", "com.atharok.barcodescanner.presentation.views.activities.MainActivity"],
    //         "uri": "jkos://show_qr_code"
        }).start(callbackExitApp, (e) => {
            cordova.plugins.backgroundMode.moveToForeground();
            alert(JSON.stringify(e))
